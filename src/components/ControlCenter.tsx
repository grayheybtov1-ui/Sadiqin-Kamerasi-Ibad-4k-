...
import { MapPin, AlertTriangle, Shield, Activity, Camera, ArrowRight, Bell, Settings, Search, Clock } from 'lucide-react';
import Dashboard from './Dashboard';

// Custom Azerbaijan Map Component
const AzerbaijanMap = ({ onSelectCity, activeViolations }: { onSelectCity: (city: string) => void, activeViolations: any[] }) => {
  return (
    <div className="relative w-full aspect-[4/3] flex items-center justify-center p-4">
      {/* SVG Map of Azerbaijan (Simplified version for performance) */}
      <svg
        viewBox="0 0 1024 1024"
        className="w-full h-full drop-shadow-[0_0_30px_rgba(37,99,235,0.2)]"
...
const ControlCenter = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col font-sans selection:bg-blue-500/30">
      {/* Top Navigation */}
      <nav className="h-20 border-b border-white/5 glass flex items-center justify-between px-10 z-50">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10">
            ...
            <input type="text" placeholder="Axtarış..." className="bg-transparent border-none outline-none text-xs w-32" />
          </div>
          ...
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 border-2 border-white/20" />
        </div>
      </nav>
      ...
      <div className="flex-1 grid grid-cols-12 gap-6 p-8 overflow-hidden">
        ...
        <div className="col-span-12 lg:col-span-6 glass-card p-8 relative flex flex-col items-center justify-center overflow-hidden">
          <div className="absolute top-8 left-8">
            <h2 className="text-3xl font-black leading-tight">Azərbaycan <br /><span className="text-blue-500">Nəzarət Xəritəsi</span></h2>
            <p className="text-white/40 text-sm mt-2 font-medium">Bütün bölgələr üzrə real-vaxt monitorinqi</p>
          </div>
          ...
          <div className="absolute bottom-8 right-8 flex items-center gap-4">
            ...
            <LegendItem color="bg-yellow-500" label="Xəbərdarlıq" />
            <LegendItem color="bg-blue-500" label="Normal" />
          </div>
        </div>

        {/* Right Sidebar - Details/Feed */}
        <div className="col-span-12 lg:col-span-3 flex flex-col gap-6">
          <motion.div
          ...
          >
            ...
            <div className="mt-6 pt-6 border-t border-white/5">
              <button className="w-full py-4 bg-blue-600 rounded-2xl font-bold text-sm shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:bg-blue-500 transition-all flex items-center justify-center gap-2 group">
